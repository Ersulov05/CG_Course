...
public:
	...
	virtual void DrawStripLine(const Point &p0, const Point &p1, float stripSize = 1.0f, float thickness = 1.0f) = 0;
	...
	virtual void DrawCubeBezie(const Point &p0, const Point &p1, const Point &p2, const Point &p3) = 0;
