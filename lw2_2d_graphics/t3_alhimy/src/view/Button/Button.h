...
public:
    ...
    void Draw(unsigned &zIndex)
    {
        ...
        auto boundSize = m_canvas.GetTextSize(m_text, size);
        m_canvas.DrawString(m_text, {m_position.x + m_size.width / 2 - boundSize.width / 2, m_position.y + m_size.height / 2 - boundSize.height / 2}, size);
    }
